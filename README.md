...
🪖 **Simple military looking loading screen for fivem**

Clean and easy to use military loading screen. First build that i made. I got some help tho, but its still perfect.
...
1. Drop `fx_loadingscreen` into your `resources` folder
2. Add `ensure fx_loadingscreen` at the **top** of your `server.cfg`
3. Open `html/config.js` and fill in your server IP, name, colors and playlist
4. Put your images in `html/img/` and music in `html/music/`
5. Done ✅
...
None. Works on any FiveM server out of the box.

---

> **Notes**

* Music starts on the first click - looking for a fix
* Images are not included, add your own military photos (recommended: 1920×1080)
* Free to use, feel free to modify for your own server
* If you have any ideas, feel free to send them to me.
